...
{
    [TestClass]
    public class AssignDepToCourseGet_Should
    {
        [TestMethod]
        public void ReturnDeafaultPartialView()
        {
            //Arrange
            ...
            //Act & Assert
            controller.WithCallTo(x => x.AssignDepToCourse()).ShouldRenderDefaultPartialView();
        }
    }
}
